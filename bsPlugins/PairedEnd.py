...
in_parameters = [{'id': 'bamfiles', 'type': 'bam', 'required': True, 'multiple': 'BamMulti', 'label': 'Paired-end BAM files: ', 'help_text': 'Select bam files'},
                 {'id': 'format', 'type': 'text', 'label': 'Output format: ', 'help_text': 'Format of the output file', 'options': ["sql", "bedGraph", "bigWig"], 'prompt_text':None},
                 ...
                 {'id': 'plot_only', 'type': 'boolean', 'label': 'Only the plot: ', 'help_text':'Do not compute the density', 'value': Fasle}]
