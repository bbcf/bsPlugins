...
class Test_DomainogramsPlugin(TestCase):
    ...
    def test_domainograms(self):
        self.plugin(**{'sample':path+'segToFrag_part.bedGraph', 'name':'test_domainogram', 'region':'chr16', 'wmax_domainograms':'50', 'wmax_BRICKS':'500'})
    ...
    def test_domainograms_upDown(self):
        self.plugin(**{'sample':path+'segToFrag_part.bedGraph', 'name':'test_domainogram', 'region':'chr16:29927651-29928325', 'wmax_domainograms':'50', 'wmax_BRICKS':'500'})
        res_tar = tarfile.open(self.plugin.output_files[0][0], "r:gz")
